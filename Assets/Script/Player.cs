...
public class Player : MonoBehaviour
{
    ...
    // public float minDistance = 1.0f;// 相机离不可穿过的表面的最小距离（小于等于0时可穿透任何表面）
    #endregion
    ...
    void Update()
    {
        ...
        // }
        tourCamera.Translate(direction * moveSpeed * Time.fixedDeltaTime, Space.World);
    }
